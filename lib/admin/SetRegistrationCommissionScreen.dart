...
class SetRegistrationCommissionScreen extends Base {
  @override
  _SSetRegistrationCommissionScreenState createState() => _SSetRegistrationCommissionScreenState();
  SetRegistrationCommissionScreen ({Key? key,});
}

class _SSetRegistrationCommissionScreenState extends BaseState{
          ...
          child: Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 70,),
                  Text("Kindly set up how much in digit, each user will be getting "
                      "from registration bonus ", style: TextStyle(fontSize: 20),),
                   SizedBox(height: 20,),
  ...
  _setCommission() async {
    ...
    //  if (_selectedState &&  ) {
      ...
      print("Exception - setRegistrationcommissionScreen.dart - _updateaboutme():" + e.toString());
    }
  }
